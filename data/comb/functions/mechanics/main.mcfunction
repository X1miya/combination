...
execute if entity @e[type=item,nbt={Item:{tag:{it:1}}}] run tp @a 1 -59 -15
execute if entity @e[type=item,nbt={Item:{tag:{it:1}}}] if score *level main matches 6.. run scoreboard players set *level main 1
execute if entity @e[type=item,nbt={Item:{tag:{it:1}}}] run function comb:mechanics/restart
execute if entity @e[type=item,nbt={Item:{tag:{it:2}}}] run function comb:mechanics/mistake
